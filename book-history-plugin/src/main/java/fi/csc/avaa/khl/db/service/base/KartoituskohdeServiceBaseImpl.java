...
import fi.csc.avaa.khl.db.service.KartoituskohdeService;
...
/**
 * Provides the base implementation for the kartoituskohde remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.KartoituskohdeServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class KartoituskohdeServiceBaseImpl extends BaseServiceImpl
    implements KartoituskohdeService, IdentifiableBean {
    ...
    private KartoituskohdeServiceClpInvoker _clpInvoker = new KartoituskohdeServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.KartoituskohdeServiceUtil} to access the kartoituskohde remote service.
     */
