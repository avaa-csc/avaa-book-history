 ...
 * @generated
 */
public class MaakuntainfoLocalServiceClp implements MaakuntainfoLocalService {
    ...
    public MaakuntainfoLocalServiceClp(
    ...
    public fi.csc.avaa.khl.db.model.Maakuntainfo addMaakuntainfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(maakuntainfo) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.khl.db.model.Maakuntainfo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Maakuntainfo createMaakuntainfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { maakuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Maakuntainfo deleteMaakuntainfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { maakuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Maakuntainfo fetchMaakuntainfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { maakuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Maakuntainfo getMaakuntainfo(int maakuntaid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { maakuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.khl.db.model.Maakuntainfo> getMaakuntainfos(
        ...
        return (java.util.List<fi.csc.avaa.khl.db.model.Maakuntainfo>) ClpSerializer.translateOutput(returnObj);
    }
