...
import fi.csc.avaa.khl.db.service.KieliinfoLocalService;
...
/**
 * Provides the base implementation for the kieliinfo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.KieliinfoLocalServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class KieliinfoLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements KieliinfoLocalService, IdentifiableBean {
    ...
    private KieliinfoLocalServiceClpInvoker _clpInvoker = new KieliinfoLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.KieliinfoLocalServiceUtil} to access the kieliinfo local service.
     */
    ...
    @Override
    public Kieliinfo addKieliinfo(Kieliinfo kieliinfo)
        throws SystemException {
        kieliinfo.setNew(true);

        return kieliinfoPersistence.update(kieliinfo);
    }
     ...
     */
    @Override
    public Kieliinfo createKieliinfo(int kieliid) {
        return kieliinfoPersistence.create(kieliid);
    }
    ...
    @Override
    public Kieliinfo deleteKieliinfo(int kieliid)
        throws PortalException, SystemException {
        return kieliinfoPersistence.remove(kieliid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Kieliinfo deleteKieliinfo(Kieliinfo kieliinfo)
        throws SystemException {
        return kieliinfoPersistence.remove(kieliinfo);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Kieliinfo.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return kieliinfoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return kieliinfoPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return kieliinfoPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Kieliinfo fetchKieliinfo(int kieliid) throws SystemException {
        return kieliinfoPersistence.fetchByPrimaryKey(kieliid);
    }
     ...
     */
    @Override
    public Kieliinfo getKieliinfo(int kieliid)
        throws PortalException, SystemException {
        return kieliinfoPersistence.findByPrimaryKey(kieliid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return kieliinfoPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Kieliinfo> getKieliinfos(int start, int end)
        throws SystemException {
        return kieliinfoPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getKieliinfosCount() throws SystemException {
        return kieliinfoPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Kieliinfo updateKieliinfo(Kieliinfo kieliinfo)
        throws SystemException {
        return kieliinfoPersistence.update(kieliinfo);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("fi.csc.avaa.khl.db.model.Kieliinfo",
            kieliinfoLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = kieliinfoPersistence.getDataSource();
