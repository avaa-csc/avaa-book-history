 ...
 * @generated
 */
public class KielestaLocalServiceClp implements KielestaLocalService {
    ...
    public KielestaLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.avaa.khl.db.model.Kielesta addKielesta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kielesta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.khl.db.model.Kielesta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.khl.db.model.Kielesta> getKielestas(
        ...
        return (java.util.List<fi.csc.avaa.khl.db.model.Kielesta>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Kielesta findByKieli(java.lang.String kieli)
        ...
        try {
            ...
            if (t instanceof fi.csc.avaa.khl.db.NoSuchKielestaException) {
                throw (fi.csc.avaa.khl.db.NoSuchKielestaException) t;
            }
