...
import fi.csc.avaa.khl.db.service.TeospkService;
...
/**
 * Provides the base implementation for the teospk remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.TeospkServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class TeospkServiceBaseImpl extends BaseServiceImpl
    implements TeospkService, IdentifiableBean {
    ...
    private TeospkServiceClpInvoker _clpInvoker = new TeospkServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.TeospkServiceUtil} to access the teospk remote service.
     */
