...
import fi.csc.avaa.khl.db.service.KuntoluokitusLocalService;
...
/**
 * Provides the base implementation for the kuntoluokitus local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.KuntoluokitusLocalServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class KuntoluokitusLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements KuntoluokitusLocalService,
        IdentifiableBean {
    ...
    private KuntoluokitusLocalServiceClpInvoker _clpInvoker = new KuntoluokitusLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.KuntoluokitusLocalServiceUtil} to access the kuntoluokitus local service.
     */
    ...
    @Override
    public Kuntoluokitus addKuntoluokitus(Kuntoluokitus kuntoluokitus)
        throws SystemException {
        kuntoluokitus.setNew(true);

        return kuntoluokitusPersistence.update(kuntoluokitus);
    }
     ...
     */
    @Override
    public Kuntoluokitus createKuntoluokitus(int kuntoid) {
        return kuntoluokitusPersistence.create(kuntoid);
    }
    ...
    @Override
    public Kuntoluokitus deleteKuntoluokitus(int kuntoid)
        throws PortalException, SystemException {
        return kuntoluokitusPersistence.remove(kuntoid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Kuntoluokitus deleteKuntoluokitus(Kuntoluokitus kuntoluokitus)
        throws SystemException {
        return kuntoluokitusPersistence.remove(kuntoluokitus);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Kuntoluokitus.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return kuntoluokitusPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return kuntoluokitusPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Kuntoluokitus fetchKuntoluokitus(int kuntoid)
        throws SystemException {
        return kuntoluokitusPersistence.fetchByPrimaryKey(kuntoid);
    }
     ...
     */
    @Override
    public Kuntoluokitus getKuntoluokitus(int kuntoid)
        throws PortalException, SystemException {
        return kuntoluokitusPersistence.findByPrimaryKey(kuntoid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return kuntoluokitusPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Kuntoluokitus> getKuntoluokituses(int start, int end)
        throws SystemException {
        return kuntoluokitusPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getKuntoluokitusesCount() throws SystemException {
        return kuntoluokitusPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Kuntoluokitus updateKuntoluokitus(Kuntoluokitus kuntoluokitus)
        throws SystemException {
        return kuntoluokitusPersistence.update(kuntoluokitus);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("fi.csc.avaa.khl.db.model.Kuntoluokitus",
            kuntoluokitusLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = kuntoluokitusPersistence.getDataSource();
