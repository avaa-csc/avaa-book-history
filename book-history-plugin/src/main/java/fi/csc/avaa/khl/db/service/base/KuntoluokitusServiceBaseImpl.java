...
import fi.csc.avaa.khl.db.service.KuntoluokitusService;
...
/**
 * Provides the base implementation for the kuntoluokitus remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.KuntoluokitusServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class KuntoluokitusServiceBaseImpl extends BaseServiceImpl
    implements KuntoluokitusService, IdentifiableBean {
    ...
    private KuntoluokitusServiceClpInvoker _clpInvoker = new KuntoluokitusServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.KuntoluokitusServiceUtil} to access the kuntoluokitus remote service.
     */
