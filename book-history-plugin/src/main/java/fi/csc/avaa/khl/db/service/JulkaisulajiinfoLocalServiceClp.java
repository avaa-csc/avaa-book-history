 ...
 * @generated
 */
public class JulkaisulajiinfoLocalServiceClp
    ...
    public JulkaisulajiinfoLocalServiceClp(
        ...
        _methodName19 = "findByJulkaisulaji";
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo addJulkaisulajiinfo(
        ...
        return (fi.csc.avaa.khl.db.model.Julkaisulajiinfo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo createJulkaisulajiinfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { julklajiid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo deleteJulkaisulajiinfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { julklajiid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo fetchJulkaisulajiinfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { julklajiid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo getJulkaisulajiinfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { julklajiid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.khl.db.model.Julkaisulajiinfo> getJulkaisulajiinfos(
        ...
        return (java.util.List<fi.csc.avaa.khl.db.model.Julkaisulajiinfo>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo findByJulkaisulaji(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] { ClpSerializer.translateInput(julkaisulaji) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
            ...
            if (t instanceof fi.csc.avaa.khl.db.NoSuchJulkaisulajiinfoException) {
                throw (fi.csc.avaa.khl.db.NoSuchJulkaisulajiinfoException) t;
            }
