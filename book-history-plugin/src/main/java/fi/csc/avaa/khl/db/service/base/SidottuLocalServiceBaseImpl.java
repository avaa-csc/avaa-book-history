...
import fi.csc.avaa.khl.db.service.SidottuLocalService;
...
/**
 * Provides the base implementation for the sidottu local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.SidottuLocalServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class SidottuLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements SidottuLocalService, IdentifiableBean {
    ...
    private SidottuLocalServiceClpInvoker _clpInvoker = new SidottuLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.SidottuLocalServiceUtil} to access the sidottu local service.
     */
    ...
    @Override
    public Sidottu addSidottu(Sidottu sidottu) throws SystemException {
        sidottu.setNew(true);

        return sidottuPersistence.update(sidottu);
    }
     ...
     */
    @Override
    public Sidottu createSidottu(int sidontaid) {
        return sidottuPersistence.create(sidontaid);
    }
    ...
    @Override
    public Sidottu deleteSidottu(int sidontaid)
        throws PortalException, SystemException {
        return sidottuPersistence.remove(sidontaid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Sidottu deleteSidottu(Sidottu sidottu) throws SystemException {
        return sidottuPersistence.remove(sidottu);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Sidottu.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return sidottuPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return sidottuPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return sidottuPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return sidottuPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return sidottuPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Sidottu fetchSidottu(int sidontaid) throws SystemException {
        return sidottuPersistence.fetchByPrimaryKey(sidontaid);
    }
     ...
     */
    @Override
    public Sidottu getSidottu(int sidontaid)
        throws PortalException, SystemException {
        return sidottuPersistence.findByPrimaryKey(sidontaid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return sidottuPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Sidottu> getSidottus(int start, int end)
        throws SystemException {
        return sidottuPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSidottusCount() throws SystemException {
        return sidottuPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Sidottu updateSidottu(Sidottu sidottu) throws SystemException {
        return sidottuPersistence.update(sidottu);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("fi.csc.avaa.khl.db.model.Sidottu",
            sidottuLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = sidottuPersistence.getDataSource();
