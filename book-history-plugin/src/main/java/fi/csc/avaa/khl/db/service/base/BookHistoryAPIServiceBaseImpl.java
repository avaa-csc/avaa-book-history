...
import fi.csc.avaa.khl.db.service.BookHistoryAPIService;
...
/**
 * Provides the base implementation for the book history a p i remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.BookHistoryAPIServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class BookHistoryAPIServiceBaseImpl extends BaseServiceImpl
    implements BookHistoryAPIService, IdentifiableBean {
    ...
    private BookHistoryAPIServiceClpInvoker _clpInvoker = new BookHistoryAPIServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.BookHistoryAPIServiceUtil} to access the book history a p i remote service.
     */
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = bookHistoryAPIPersistence.getDataSource();
