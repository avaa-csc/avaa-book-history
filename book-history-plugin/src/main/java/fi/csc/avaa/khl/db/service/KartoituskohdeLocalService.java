...
/**
 * Provides the local service interface for Kartoituskohde. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CSC
 * @see KartoituskohdeLocalServiceUtil
...
public interface KartoituskohdeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link KartoituskohdeLocalServiceUtil} to access the kartoituskohde local service. Add custom service methods to {@link fi.csc.avaa.khl.db.service.impl.KartoituskohdeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
