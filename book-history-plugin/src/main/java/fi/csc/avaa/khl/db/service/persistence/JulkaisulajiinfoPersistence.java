...
/**
 * The persistence interface for the julkaisulajiinfo service.
 *
 * <p>
 ...
 * @generated
 */
public interface JulkaisulajiinfoPersistence extends BasePersistence<Julkaisulajiinfo> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link JulkaisulajiinfoUtil} to access the julkaisulajiinfo persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
     */
    ...
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo findByJulklaji(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo fetchByJulklaji(
        java.lang.String julklaji)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo removeByJulklaji(
        java.lang.String julklaji)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.khl.db.NoSuchJulkaisulajiinfoException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public int countByJulklaji(java.lang.String julklaji)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo create(int julklajiid);
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo remove(int julklajiid)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.khl.db.NoSuchJulkaisulajiinfoException;

    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo updateImpl(
        fi.csc.avaa.khl.db.model.Julkaisulajiinfo julkaisulajiinfo)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo findByPrimaryKey(
        int julklajiid)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.khl.db.NoSuchJulkaisulajiinfoException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.khl.db.model.Julkaisulajiinfo fetchByPrimaryKey(
        int julklajiid)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.avaa.khl.db.model.Julkaisulajiinfo> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
