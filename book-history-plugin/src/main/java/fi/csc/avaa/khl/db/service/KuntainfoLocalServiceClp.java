 ...
 * @generated
 */
public class KuntainfoLocalServiceClp implements KuntainfoLocalService {
    ...
    public KuntainfoLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "findByCapitalkuntanimi";
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo addKuntainfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kuntainfo) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.khl.db.model.Kuntainfo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo createKuntainfo(int kuntaid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { kuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo deleteKuntainfo(int kuntaid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { kuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo fetchKuntainfo(int kuntaid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { kuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo getKuntainfo(int kuntaid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { kuntaid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.khl.db.model.Kuntainfo> getKuntainfos(
        ...
        return (java.util.List<fi.csc.avaa.khl.db.model.Kuntainfo>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.khl.db.model.Kuntainfo findByCapitalkuntanimi(
        ...
        try {
            ...
            if (t instanceof fi.csc.avaa.khl.db.NoSuchKuntainfoException) {
                throw (fi.csc.avaa.khl.db.NoSuchKuntainfoException) t;
            }
