...
import fi.csc.avaa.khl.db.service.VanhatkirjatService;
...
/**
 * Provides the base implementation for the vanhatkirjat remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.khl.db.service.impl.VanhatkirjatServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class VanhatkirjatServiceBaseImpl extends BaseServiceImpl
    implements VanhatkirjatService, IdentifiableBean {
    ...
    private VanhatkirjatServiceClpInvoker _clpInvoker = new VanhatkirjatServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.khl.db.service.VanhatkirjatServiceUtil} to access the vanhatkirjat remote service.
     */
